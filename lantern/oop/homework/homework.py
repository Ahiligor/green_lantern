...
class House:
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    # * Implement method create_window which will create new window using class Window and add it to  ✔
    # the __windows list  ✔
    #   it receives parameters width and height ✔
    #   if width or height eq 0 raise ValueError "Value must be not 0" ✔
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        if roll_width_m == 0 and roll_length_m == 0:
            ...
            sum_of_rolls_of_wallpaper = 0
            for wall in self.__walls:
                rolls_of_wallpaper_for_one_wall = wall.number_of_rolls_of_wallpaper(roll_width_m, roll_length_m)
                sum_of_rolls_of_wallpaper += rolls_of_wallpaper_for_one_wall
            return sum_of_rolls_of_wallpaper

    # * Implement method get_room_square that returns the square of our room
    #   (from walls_square minus windows and door square)
